@echo off
rem Scratch: rebuild ONLY the p10 cpu moe test (debug iteration).
...
cmake --build "core\build" --target ninfer_engine ninfer_qwen3_8_flash_next_test_p10_cpu_moe -j8
