@echo off
rem Build flash_next engine against the relocated core tree.
rem Core tree: C:\Users\Micke\Documents\Kodprojekt\Ninfer\ninfer-win
...
cmake --build "C:\Users\Micke\Documents\Kodprojekt\Ninfer\ninfer-win\build" --target ninfer_engine flash_next_real_load -j8 2>&1
