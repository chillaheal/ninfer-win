@echo off
rem P2 build step for tools\flash_next_dev\run_phase.sh (no double quotes in the
...
cmake --build "C:\Users\Micke\Documents\Ninfer\ninfer-win\build" --target flash_next_mini_fixture flash_next_p2_identity_test flash_next_p2_planner_test flash_next_p2_binder_test -j8
