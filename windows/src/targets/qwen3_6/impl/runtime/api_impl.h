...
// Real bodies rather than '= default': MSVC only emits an out-of-line '= default' special-member
// definition when it is odr-used in this translation unit, so consumer TUs (engine.cpp,
// registry.cpp) would be left with unresolved references to the move operations.
template <>
