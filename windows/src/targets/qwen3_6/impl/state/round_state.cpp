...
DFlashDecodeState::DFlashDecodeState(DeviceSpan backing, const DFlashDecodeStateLayout& layout,
    ...
    ngram_tokens = ingress_tensor(offsetof(DFlashDecodeIngress, ngram_tokens), DType::I32,
                           {kDFlashDecodeMaximumDrafts, batch});
    ngram_counts = ingress_tensor(offsetof(DFlashDecodeIngress, ngram_counts), DType::I32, {batch});
    sampling = reinterpret_cast<const ops::SamplingConfig*>(
