...
// server_system_prompt_default: non-empty => injected as the leading system instruction for
// clients that send none (an empty leading system turn is replaced; a non-empty client
// system always wins and is never concatenated).
