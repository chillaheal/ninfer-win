...
public:
    ...
    // Capabilities of the resolved chat template (digest hex, semantics, effort), as loaded at
    // startup. Served by /health; the serve holds it for the process lifetime.
