...
// Definition of the shared normalizer declared in options_normalize.h; external linkage so the
// probe translation unit (targets/registry.cpp) can link against it.
