...
# Windows lacks these two POSIX syscalls (perf hint + flush-to-disk); stand in with
# a no-op and the stdlib-equivalent flush so the Linux-only converter runs unchanged here.
if not hasattr(os, "posix_fadvise"):
    os.posix_fadvise = lambda *args, **kwargs: None
